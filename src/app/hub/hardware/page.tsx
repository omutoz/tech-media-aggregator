...
export default function HardwareHub() {
  ...
  const fetchHardwareArticles = async () => {
    setLoading(true);
    try {
    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex-1 flex flex-col">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl font-black tracking-tight text-white uppercase">
              Залізо та Гаджети <span className="text-purple-500">Хаб</span>
            </h1>
          </div>
          <p className="text-xs text-gray-400">Спеціальний розділ агрегатора: детальні огляди відеокарт, процесорів, ноутбуків, смартфонів та геймерських девайсів</p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
        <form onSubmit={handleSearch} className="w-full sm:max-w-md flex gap-2">
          <input
            type="text"
            placeholder="Шукати в Залізо Хабі..."
            value={search}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          {loading && articles.length === 0 ? (
            ...
            <div className="glass-card p-12 text-center border border-gray-800/40 bg-[#0C0C16]/20">
              ...
              <h3 className="text-sm font-bold text-gray-300 mt-3">Матеріалів про залізо не знайдено</h3>
        ...
        <div className="flex flex-col gap-6">
          <div className="glass-card p-5 bg-gradient-to-br from-[#120B20]/40 to-[#0A0A16]/50">
            <h3 className="text-xs font-bold text-purple-400 uppercase tracking-wider mb-2.5">🔌 Про Залізо Хаб</h3>
            <p className="text-xs text-gray-300 leading-relaxed mb-3">
              Цей хаб призначений для технічних ентузіастів, геймерів та розробників, яким важливі апаратні новини.
            </p>
            <p className="text-xs text-gray-400 leading-relaxed">
              Тут публікуються матеріали про мікропроцесори, мобільні чипи, відеоприскорювачі та нові консолі. Система автоматично фільтрує та виділяє технічні матеріали в окрему стрічку.
            </p>
          </div>
        </div>
      </div>
