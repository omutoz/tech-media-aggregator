      ...
      <header className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-gray-800/60 pb-6 mb-6 gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-xl text-purple-500 font-extrabold">🤖</span>
            <h1 className="text-xl font-black tracking-tight text-white uppercase">
              Штучний Інтелект <span className="text-purple-500">Хаб</span>
            </h1>
          </div>
          <p className="text-xs text-gray-400">Спеціальний розділ агрегатора: все про LLMs, нейромережі, ШІ-стартапи та обчислювальні моделі</p>
        </div>
        ...
        <div className="flex items-center gap-4 text-xs font-semibold">
          ...
          <a href="/hub/articles" className="text-gray-400 hover:text-purple-300 transition-colors">
            ✍️ Статті
          </a>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          {loading && articles.length === 0 ? (
            ...
            <div className="glass-card p-12 text-center border border-gray-800/40 bg-[#0C0C16]/20">
              ...
              <h3 className="text-sm font-bold text-gray-300 mt-3">Матеріалів про ШІ не знайдено</h3>
              <p className="text-xs text-gray-500 mt-1">Очікуйте оновлень стрічки або перевірте пошуковий запит.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col gap-6">
          <div className="glass-card p-5 bg-gradient-to-br from-[#120B20]/40 to-[#0A0A16]/50">
            <h3 className="text-xs font-bold text-purple-400 uppercase tracking-wider mb-2.5">🧬 Про ШІ Хаб</h3>
            <p className="text-xs text-gray-300 leading-relaxed mb-3">
              Цей розділ автоматично збирає всі новини про штучний інтелект від 14 провідних українських медіа.
            </p>
            <p className="text-xs text-gray-400 leading-relaxed">
              Система автоматично сканує вміст кожної статті, маркує відповідними підтегами та класифікує матеріали, допомагаючи вам залишатися в курсі останніх технологічних зрушень.
            </p>
          </div>
        </div>
      </div>
